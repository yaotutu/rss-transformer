...
export class WinstonService {
  ...
  log(type: LogType, message: string = '', error?: Error | string) {
  ...
  warn(type: LogType, message: string = '', error?: Error | string) {
    let logMessage = `${message}`;
    if (error instanceof Error) {
      logMessage = `${message} - ${error.message}`;
  ...
  debug(type: LogType, message: string = '', error?: Error | string) {
    let logMessage = `${message}`;
    if (error instanceof Error) {
      logMessage = `${message} - ${error.message}`;
  ...
  verbose(type: LogType, message: string = '', error?: Error | string) {
    let logMessage = `${message}`;
    if (error instanceof Error) {
      logMessage = `${message} - ${error.message}`;
